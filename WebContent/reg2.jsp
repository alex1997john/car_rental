                ...
                <div class="col-lg-5 col-md-8 m-auto">
                	<div class="login-page-content">
                		<div class="login-form">
                			<h3>Verification</h3>
							<form action="verificationprocess.jsp">
								
								<div class="dlno">
									<input type="text" name="dlno" placeholder="Driving Licence Number">
								</div>
								<div >
 Front Page:
								</div>
								...
								<div class="dlimage1">
								    <input type="file" name="dlfront" placeholder="insert your front of driving licence">
								</div>
Back page:
								<div class="dlimage2">
								    <input type="file" name="dlback" placeholder="insert your back of driving licence">
								</div>
