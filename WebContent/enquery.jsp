	...
	<div class="limiter">
		<div class="container-table100">
 		...
 		con=DriverManager.getConnection(url, userName, passcode);
 		 PreparedStatement ps=con.prepareStatement("select * from querytable");
...
<tbody>
								<tr>
									...
									<td class="column4"></td>
									<td class="column5"><%=rs.getString("msg")%></td>
									<td class="column6"></td>
									<td class="column6"><%=rs.getString("sub")%></td>
									<td class="column6"></td>
									<td class="column6"></td>
									<td class="column6"><%=rs.getString("email")%></td>
									<td class="column6"></td>
									<td class="column6"></td>
								</tr>
