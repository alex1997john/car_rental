                ...
                <div class="col-lg-5 col-md-8 m-auto">
                	<div class="login-page-content">
                		<div class="login-form">
                			<h3><center>Edit</center></h3>
							<form action='editprocess.jsp?value="<%=rs.getString("fname") %>"' name="form1" onsubmit = "return(validate());">
                                ...
                                <div>
                                 <input id="startDate1" name="dob" value="<%=rs.getString("dob") %>" placeholder="Pick Up Date" >
                                    
                                </div>
                                <div class="mobilenumber">
                                    <input type="number" name="mobileno" value="<%=rs.getString("mobno")%> "placeholder="Mobile Number" required>
								</div>
								<div class="username">
									<input type="email" name="email" value="<%=rs.getString("email") %>" placeholder="Email" required>
                                </div>
                                
								
                                
								<div class="log-btn">
								<button type="submit" ><i class="fa fa-check-square"></i> Edit</button></a>	
								</div>
							</form>
                		</div>
